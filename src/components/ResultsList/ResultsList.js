...
import Arrow from '../../assets/arrow.png' //.. moves 1 folder above
            ...
            <div className="results-list-container">
                <div className="results-list">
                    {props.results.map((item, i)=>{
                        if (item.results.toUpperCase() !== 'out of bussiness'.toUpperCase()){
                            return (
        ...
        return(
            <div className="results-list-container">
                <div className="no-results-found">
                    <h2>Sorry, we couldn't find restaurants with that name</h2>
                </div>
            </div>
        )
    } 
